...
<script src="${pageContext.request.contextPath}/member/joinus/join.js"></script>
			...
			<div class="table-container">
				<div class="layout-fix">
						...
						<div class="memberJoin-wrap"> 
                         <form action="${pageContext.request.contextPath}/member/joinus/register.htm" method="post" onsubmit="return validateForm() && validatePassword() && validateAuth();">
									...
									<div class="agreeAllWrap">
										<div class="agreeAllBox">
											<div class="agreeAllinner">
												<p class="check">
													<span class="chk-base"> 
                                                        <input type="checkbox" id="AgreeAllCk" name="usersnsagree" value="Y" onclick="allAgreeBtn()"> 
									...
									<div class="termAgree-container" id="adAgreeWrap">
										...
										<ul class="check-list">
											<li><span>SMS, 카카오톡 수신동의</span> <input type="checkbox"
												id="smsAgree"  class="termCK" onclick="updateSelectAll()"> <label
												for="smsAgree">동의함</label></li>

											<li><span>이메일 수신동의</span> <input type="checkbox"
												id="emailAgree"  class="termCK" onclick="updateSelectAll()"> <label
                                        ...
                                        <table class="formTable">
											...
											<tr class="checked-vali">
												...
												<tr class="checked-vali">
												    ...
												    <td>
												        <input type="text" id="email" name="useremail" data-checked="false" value="${user.useremail}">
													...
													<tr class="checked-vali">
													    ...
													    <th scope="row">
													       ...
													       <td>
													        <input type="text" id="phone" name="usertel" data-checked="false" value="${user.usertel}">
													        <button type="button" onclick="checkDuplication('phone', 'phone', 'phoneMsg')">휴대폰 인증</button>
													        <!-- 서버 검증 에러 메시지 -->
													        <span class="error">${usertelError}</span>
													        <!-- 중복 확인 메시지 -->
												...
												<tr class="birth">
													<th scope="row">
														<span class="SP_th_Title">생년<br>월일</span>
                                                           ...
                                                           <td>
												        <input type="text" id="birth-year" name="birthYear" placeholder="년도" maxlength="4">
												        <input type="text" id="birth-month" name="birthMonth" placeholder="월" maxlength="2">
												        <input type="text" id="birth-day" name="birthDay" placeholder="일" maxlength="2">
												        <%-- <input type="hidden" id="userbirth" name="userbirth" value="${user.userbirth}"> --%>
												        <!-- 서버 검증 에러 메시지 -->
												        <span class="error">${userbirthError}</span>
												    </td>
												</tr>
											</tbody>	
                                        </table>
